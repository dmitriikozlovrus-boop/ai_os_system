...
Для проектных меток и Stream-разделов Todoist является источником истины: ручная сортировка
в интерфейсе Todoist записывается в Notion и не может быть отменена более старой маршрутизацией Notion.
